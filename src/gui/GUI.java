...
public class GUI extends Application
{
    ...
    private void populateExamples()
    {
        ...
        try
        {
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable1 = new SemaphoreTable<>();
            ProgramState prgState1 = new ProgramState(stack1, symT1, output1, fileTable1, heap1, semTable1, ex1);
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable2 = new SemaphoreTable<>();
            ProgramState prgState2 = new ProgramState(stack2, symT2, output2, fileTable2, heap2, semTable2, ex2);
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable3 = new SemaphoreTable<>();
            ProgramState prgState3 = new ProgramState(stack3, symT3, output3, fileTable3, heap3, semTable3, ex3);
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable4 = new SemaphoreTable<>();
            ProgramState prgState4 = new ProgramState(stack4, symT4, output4, fileTable4, heap4, semTable4, ex4);
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable5 = new SemaphoreTable<>();
            ProgramState prgState5 = new ProgramState(stack5, symT5, output5, fileTable5, heap5, semTable5, ex5);
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable6 = new SemaphoreTable<>();
            ProgramState prgState6 = new ProgramState(stack6, symT6, output6, fileTable6, heap6, semTable6, ex6);
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable7 = new SemaphoreTable<>();
            ProgramState prgState7 = new ProgramState(stack7, symT7, output7, fileTable7, heap7, semTable7, ex7);
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable8 = new SemaphoreTable<>();
            ProgramState prgState8 = new ProgramState(stack8, symT8, output8, fileTable8, heap8, semTable8, ex8);
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable9 = new SemaphoreTable<>();
            ProgramState prgState9 = new ProgramState(stack9, symT9, output9, fileTable9, heap9, semTable9, ex9);
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable10 = new SemaphoreTable<>();
            ProgramState prgState10 = new ProgramState(stack10, symT10, output10, fileTable10, heap10, semTable10, ex10);
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable11 = new SemaphoreTable<>();
            ProgramState prgState11 = new ProgramState(stack11, symT11, output11, fileTable11, heap11, semTable11, ex11);
            ...
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable12 = new SemaphoreTable<>();
            ProgramState prgState12 = new ProgramState(stack12, symT12, output12, fileTable12, heap12, semTable12, ex12);
            ...
            Statement ex13 = new CompStatement(  new VarDeclStatement("v1", new RefType(new IntType()))  ,new CompStatement(  new VarDeclStatement("cnt", new IntType())  ,new CompStatement(  new NewStatement("v1", new ValueExpression(new IntValue(1)))  ,new CompStatement(  new CreateSemaphoreStatement("cnt", new ReadHeapExpression(new VariableExpression("v1")))  ,new CompStatement(  new ForkStatement(new CompStatement(new AcquireStatement("cnt"), new CompStatement(new WriteHeapStatement("v1", new ArithmeticExpression("*", new ReadHeapExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(10)))), new CompStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v1"))), new ReleaseStatement("cnt")))))  ,new CompStatement(  new ForkStatement(new CompStatement( new AcquireStatement("cnt"),new CompStatement( new WriteHeapStatement("v1", new ArithmeticExpression("*", new ReadHeapExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(10)))),new CompStatement(new WriteHeapStatement("v1", new ArithmeticExpression("*", new ReadHeapExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(2)))),new CompStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v1"))) ,new ReleaseStatement("cnt"))))))  ,new CompStatement( new AcquireStatement("cnt")   ,new CompStatement( new PrintStatement(new ArithmeticExpression("-", new ReadHeapExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(1)))),new ReleaseStatement("cnt")))))))));

            ex13.typeCheck(new TypeEnv<>());

            IExecutionStack<Statement> stack13 = new ExecutionStack<>();
            ISymTable<String, Value> symT13 = new SymTable<>();
            IOutput<Value> output13 = new Output<>();
            IFileTable<StringValue, BufferedReader> fileTable13 = new FileTable<>();
            IHeap<Integer, Value> heap13 = new Heap<>();
            ISemaphoreTable<Integer, Pair<Integer, List<Integer>>> semTable13 = new SemaphoreTable<>();
            ProgramState prgState13 = new ProgramState(stack13, symT13, output13, fileTable13, heap13, semTable13, ex13);

            IRepository repo13 = new Repository("ex13.log");
            repo13.add(prgState13);
            Controller serv13 = new Controller(repo13, ex13);
            serv13.setDisplayPrgStateFlagTrue();
    ...
    private void showMainWindow(Controller controller)
    {
        ...
        // semTable - TableView
        TableView<Map.Entry<Integer, Pair<Integer, List<Integer>>>> semTableView = createSemTableView(controller.getData().getFirst().getSemaphoreTable().getContent());
        ...
        oneStepButton.setOnAction(event ->
        {
            ...
            if (!updatedStates.isEmpty())
            {
                ...
                semTableView.getItems().addAll(firstState.getSemaphoreTable().getContent().entrySet());
            ...
            else
            {
                ...
                semTableView.getItems().clear();
                semTableView.getItems().addAll(controller.getFinalState().getSemaphoreTable().getContent().entrySet());
        ...
        VBox layout1 = new VBox(10,
                ...
                new Label("SemaphoreTable:"), semTableView
        );
    ...
    private TableView<Map.Entry<Integer, Pair<Integer, List<Integer>>>> createSemTableView(Map<Integer, Pair<Integer, List<Integer>>> semTable)
    {
        TableView<Map.Entry<Integer, Pair<Integer, List<Integer>>>> tableView = new TableView<>();
        TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> addressColumn = createStringColumn("Address", entry -> entry.getKey().toString());
        TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> valueColumn = createStringColumn("Value", entry -> entry.getValue().toString());
        tableView.getColumns().addAll(addressColumn, valueColumn);
        tableView.setItems(FXCollections.observableArrayList(semTable.entrySet()));
        return tableView;
    }
